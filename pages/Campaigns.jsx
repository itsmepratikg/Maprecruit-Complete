...
import {
  ...
  Heart, Network, ArrowUp, ArrowDown
} from 'lucide-react';
      ...
      <div className="bg-white dark:bg-slate-800 rounded-lg shadow-xl border border-gray-100 dark:border-slate-700 overflow-hidden relative">
        ...
        <div className="py-1">
          ...
          <div className="group/submenu relative">
            ...
            >
              <span>Source AI</span>
              <ChevronDown size={14} className="text-gray-400 -rotate-90 group-hover/submenu:text-green-600 dark:group-hover/submenu:text-green-400" />
            </button>
