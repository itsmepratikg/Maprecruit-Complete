                  ...
                  series: [
                     {
                        ...
                        type: 'line',
                        smooth: true,
                        data: TREND_DATA.map(d => d.profiles),
                     ...
                     },
                     {
                        ...
                        type: 'line',
                        smooth: true,
                        data: TREND_DATA.map(d => d.applies),
               ...
               series: [
                  {
                     ...
                     data: SOURCE_DATA.map(d => ({ value: d.value, name: d.name, itemStyle: { color: d.color } }))
                  }
               ]
            }}
            style={{ height: '100%', minHeight: '200px', width: '100%' }}
                  ...
                  series: [
                     {
                        name: 'Opened',
                        type: 'bar',
                        data: EMAIL_DATA.map(d => d.opened),
                        itemStyle: { color: '#82ca9d', borderRadius: [4, 4, 0, 0] },
                        barGap: 0
                     },
                     {
                        name: 'Bounced',
                        type: 'bar',
                        data: EMAIL_DATA.map(d => d.bounced),
                        itemStyle: { color: '#ff8042', borderRadius: [4, 4, 0, 0] }
                     }
                  ]
               }}
