...
export const CampaignDetailView = ({ campaign, onBack, onMaximizeTemplate, isScrolled, onShowMatchScore }) => {
...
export const CampaignsView = ({ onPreviewCampaign, onShowMatchScore }) => {
